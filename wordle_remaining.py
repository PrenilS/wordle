...
# %%
def play_wordle_remaining(n_games, startword, startword2, wordsarr, answerlist, freq, random_answer=True, answer=''):
    start = time.time()
    ...
    for i in range(1,n_games+1):
        if i == 1:
            ...
            for word in matches:
                ...
                word_scores.append([word, remaining, score_word(word, freq)*-1])
...
if __name__=="__main__":  
    play_wordle_remaining(5, 'toeas', 'unhip', wordsarr, answerlist, freq)
